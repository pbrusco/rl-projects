...
Como se puede observar, la aplicaci\'on de navigation rewards no tiene un efecto importante sobre el punto de convergencia, aunque s\'i ayuda a que las partidas ganadas se mantengan m\'as cercanas al \'optimo. Resulta particular el hecho de que los juegos realizados previos al punto de convergencia requieran una mayor cantidad de movimientos al aplicar estas rewards.
...
DynaNavigationRewards-result.out & 3.75e-03 & 1184 & 13 \\
