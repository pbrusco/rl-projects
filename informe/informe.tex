...
\end{figure}
	...
	Lo primero que se puede observar es que ni sarsa ni sarsa($\lambda$) están convergiendo. 
	%aca explicacion de pablo.
...
\bibitem{frmax1} Carlos Guestrin, Relu Patrascu, Dale Schuurmans: \textit{Algorithm-Directed Exploration for Model-Based Reinforcement Learning in Factored MDPs}
...
\bibitem{frmax2} Michael Kearns, Daphne Koller: \textit{Efficient Reinforcement Learning in Factored MDPs}

\bibitem{frmax3} Alexander L. Strehl, Carlos Diuk, Michael L. Littman: \textit{Efficient Structure Learning in Factored-state MDPs}
