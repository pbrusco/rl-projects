...
La aplicaci\'on de navegaci\'on estoc\'astica no produce una mejora sobre el punto de convergencia del algoritmo, el cual sigue requiriendo entre 10 y 20 iteraciones para encontrar una estrategia ganadora; la explosi\'on estoc\'astica, en cambio, s\'i permite que el algoritmo arribe a una estrategia ganadora en una cantidad \'infima de juegos.

Ambas configuraciones estoc\'asticas producen que la estrategia ganadora arribada no mantenga una cantidad constante de movimientos, pues ante una misma secuencia el algoritmo puede arribar a distintos estados. Es notable c\'omo, a pesar de estos cambios, R-Max consiga recuperarse de una acci\'on con resultado distinto del m\'as probable y generar una secuencia ganadora, sin perder en una sola ocasi\'on una vez aprendido c\'omo ganar.
...
Como se puede ver en los gráficos, el hecho de agregar la estocacidad a dyna no produce que el agente pierda mucho más pero sí empeora la velocidad de convergencia del algoritmo.
