...
\section{Objetivo}
	...
	Compararemos los resultados del aprendizaje en agentes model-free y model-based, con los algoritmos de QLearning, RMax y RMax Factorizado, Sarsa y Sarsa Lambda,  y Dyna mostrando cu\'ales de ellos funcionan mejor en nuestro caso y a qu\'e se debe esto. Adem\'as analizaremos el efecto de aplicar rewards intermedios en el tiempo de aprendizaje del agente.
...
\item NO\_ACTION\_NEGATIVE\_REWARD: Si este flag est\'a acrivado se le da un refuerzo negativo al agente cada vez que realiza una acci\'on que no cambia el estado
